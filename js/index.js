...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =================================================================
    const textoHistoria = `Na Escola <NOME DA ESCOLA DESEJADA> tudo parecia normal até que, numa manhã de segunda-feira, os sistemas da escola entraram em colapso. A rede caiu, os computadores travaram e uma mensagem enigmática apareceu em todas as tela dos computadores:\n\n“O saber foi selado. Decifrem o enigma ou permaneçam na ignorância. — Grupo Sombra”\n\nA diretoria De ensino ficou em choque. Sem acesso aos dados , avaliações e sistemas de segurança, a escola estava paralisada. A diretora <NOME> que responsável pelos equipamentos da escola pensaram sobre o problema e decidiram agir. Ela convocou os alunos do Cursos técnicos com habilidades excepcionais em tecnologia, investigação e lógica.`;
